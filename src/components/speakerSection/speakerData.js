...
export const speakers = [
  ...
  { 
    slug: "ahmed-khbeer",
    name: "Ahmed Khbeer",
    title: "Ahmed Khbeer is Partner and Group CEO at Tafaseel BPO, growing the company from seven employees to 2000+ across six countries (UAE, KSA, Egypt, Qatar, Bahrain, US), earning top CX awards and attracting global investment. Founder and CEO of OnBoard, UAE's first People-as-a-Service EOR subscription platform, and Co-Founder of Rannah.ae, the world's first automated on-demand call center subscription platform. Board member at Dubai Chamber of Commerce Contact Centers Business Group, currently building Sonic AI, the Middle East’s first voice AI Unicorn.",
    img: ahmed
  },
  { 
    slug: "waleed-akasha",
    name: "Waleed Akasha",
    title: "Waleed Akasha is a senior executive with 20 years of experience in healthcare technology across UAE, Oman, and the Middle East/Africa markets. Specializing in EHR, departmental, and imaging solutions, he has consistently achieved sales and financial goals while leading strategic initiatives for multinational companies. With 16 years in the region, Akasha has built extensive networks with healthcare decision makers including Ministries of Health, hospital officials, and IT directors, driving business development, market penetration, and revenue growth.",
    img: waleed
  },
  { 
    slug: "manel-chada-el-islam-benmahcene",
    name: "Manel Chada El Islam Benmahcene",
    title: "Manel Chada El Islam Benmahcene is a pioneer in AI for social good in North Africa. She has founded several initiatives aimed at empowering local communities through artificial intelligence and sustainable technology solutions. Her work focuses on bridging the digital divide and fostering innovation in emerging economies.",
    img: chada
  },
  { 
    slug: "sara-hegazy",
  ...
  { 
    slug: "aliaa-mohamed",
    name: "Aliaa Mohamed",
    title: "Aliaa Mohamed is an expert in digital communication and AI ethics, focusing on how emerging technologies impact social structures in the MENA region. She advises organizations on responsible AI adoption and digital transformation strategies that prioritize cultural values and societal well-being.",
    img: aliaa
  },
  { 
    slug: "haytham-el-azaizy",
    name: "Haytham El-Azaizy",
    title: "Haytham El-Azaizy is a technology leader and entrepreneur with extensive experience in developing AI-driven solutions for the enterprise sector. His work emphasizes practical applications of machine learning to solve complex business challenges and drive operational efficiency across various industries.",
    img: haythem
  },
  { 
    slug: "mohamed-osman",
    name: "Mohamed Osman",
    title: "Mohamed Osman is a researcher and practitioner in the field of artificial intelligence, specializing in natural language processing and its applications in diverse cultural contexts. He explores how AI can be designed to respect and enhance linguistic diversity and cultural heritage.",
    img: osman
  },
  { 
    slug: "raed-h-habiss",
    name: "Raed H. Habiss",
    title: "Raed H. Habiss is an expert in digital strategy and innovation, helping organizations navigate the complexities of the digital age. His work covers area such as AI governance, digital transformation, and the development of future-proof business models in the Middle East.",
    img: habibi
  },
  { 
    slug: "dr-anour-f-a-dafa-alla",
    name: "Dr. Anour F A Dafa-Alla",
    title: "Dr. Anour F A Dafa-Alla is a scholar and researcher focusing on the social and ethical implications of artificial intelligence. His work investigate how AI technologies can be designed and deployed to promote social justice, equity, and human flourishing.",
    img: dafa
  },
  { 
    slug: "krishna-raj",
    name: "Krishna Raj",
    title: "Krishna Raj is a technology innovator and entrepreneur with a focus on AI-driven solutions for global challenges. He has a track record of developing impactful technologies that address issues in sectors like education, healthcare, and sustainable development.",
    img: krishna
  },
  { 
    slug: "fady-ismaeel",
    name: "Fady Ismaeel",
    title: "Fady Ismaeel is a leader in digital media and technology, exploring how AI can transform storytelling and content creation. His work emphasizes the potential of AI to enhance human creativity and facilitate new forms of cultural expression.",
    img: fady
  },
  { 
    slug: "manal-rifki",
    name: "Manal Rifki",
    title: "Manal Rifki is an expert in AI policy and governance, advising governments and international organizations on responsible AI strategies. Her work focuses on creating ethical frameworks that balance technological innovation with societal safeguards.",
    img: manal
  },
  { 
  ...
  { 
    slug: "stephen-butler",
    name: "Stephen Butler",
    title: "Stephen Butler is Executive Director of the Compassion Institute, where he leads efforts to promote compassion through education and research. He works to integrate compassionate practices into various sectors, including healthcare, education, and social services.",
    img: butler
  },
  { 
    slug: "nichol-bradford",
    name: "Nichol Bradford",
    title: "Nichol Bradford is a pioneer in transformative technology, focusing on how emerging tech can enhance human consciousness and well-being. She is co-founder of Transformative Tech Lab and a leading voice on the intersection of AI, health, and human flourishing.",
    img: nichol
  },
  { 
    slug: "de-kai",
  ...
  { 
    slug: "dr-gali-einav",
    name: "Dr. Gali Einav",
    title: "Dr. Gali Einav is an expert in digital media and innovation, focusing on the intersection of technology, culture, and society. She leads several research initiatives exploring how emerging tech impacts human behavior and social interaction.",
    img: gali
  },
  { 
    slug: "edith-oller",
    name: "Edith Öller",
    title: "Edith Öller is a technology enthusiast and advocate for ethical AI, focusing on how digital tools can be used to foster social inclusion and sustainability. She works with organizations to develop AI strategies that prioritize human values and environmental responsibility.",
    img: edith
  },
];
